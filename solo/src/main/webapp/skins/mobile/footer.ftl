...
<div id="footer">
    ...
    <p>Powered by <a href="http://bob.kim" target="_blank">B3log 开源</a> • <a href="http://bob.kim/services/#solo" target="_blank">Solo</a> ${version},
        Theme by <a rel="friend" href="http://dx.bob.kim" target="_blank">dx</a> &lt
